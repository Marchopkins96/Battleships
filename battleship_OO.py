    ...
    def get_user_input(self):
        try:
            ...
            while x_row not in '12345678':
                print('Not an appropriate choice, please choose a valid row')
                x_row = input("Enter the row of the ship: ")

            y_column = input("Enter the column letter of the ship: ").upper()
            while y_column not in 'ABCDEFGH':
                print('Not an appropriate choice, please choose a valid row').upper()
                y_column = input("Enter the column letter of the ship: ")
            return int(x_row) -1, GameBoard.get_letters_to_numbers()[y_column]
        except ValueError and KeyError:
            print("Not a valid input choice")
...
def RunGame():
    ...
    while turns > 0:
        ...
        if computer_board.board[user_x_row][user_y_column] == "X":
            print('You sank one of my battleships!')
